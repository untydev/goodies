...
test('isUndefined() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isUndefined(values.bigIntValue))
...
test('isDefined() returns true or false depending on the argument type', (t) => {
  ...
  t.true(is.isDefined(values.bigIntValue))
...
test('isNull() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isNull(values.bigIntValue))
...
test('isBoolean() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isBoolean(values.bigIntValue))
...
test('isInteger() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isInteger(values.bigIntValue))
...
test('isNumber() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isNumber(values.bigIntValue))
...
test('isBigInt() true or false depending on the argument type', (t) => {
  t.false(is.isBigInt(values.undefinedValue))
  t.false(is.isBigInt(values.nullValue))
  t.false(is.isBigInt(values.booleanValue))
  t.false(is.isBigInt(values.integerValue))
  t.false(is.isBigInt(values.numberValue))
  t.true(is.isBigInt(values.bigIntValue))
  t.false(is.isBigInt(values.NaNValue))
  t.false(is.isBigInt(values.plusInfinityValue))
  t.false(is.isBigInt(values.minusInfinityValue))
  t.false(is.isBigInt(values.stringValue))
  t.false(is.isBigInt(values.arrayValue))
  t.false(is.isBigInt(values.typedArrayValue))
  t.false(is.isBigInt(values.mapValue))
  t.false(is.isBigInt(values.setValue))
  t.false(is.isBigInt(values.objectValue))
  t.false(is.isBigInt(values.classValue))
  t.false(is.isBigInt(values.functionValue))
  t.false(is.isBigInt(values.symbolValue))
  t.false(is.isBigInt(values.promiseValue))
})
...
test('isString() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isString(values.bigIntValue))
...
test('isArray() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isArray(values.bigIntValue))
...
test('isFunction() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isFunction(values.bigIntValue))
...
test('isObject() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isObject(values.bigIntValue))
...
test('isIterable() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isIterable(values.bigIntValue))
...
test('isSymbol() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isSymbol(values.bigIntValue))
...
test('isPromise() returns true or false depending on the argument type', (t) => {
  ...
  t.false(is.isPromise(values.bigIntValue))
